...
public class SignDownFile extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    fileName = request.getParameter("fullName");
    
    ServletOutputStream out = response.getOutputStream();
    response.setHeader("Content-disposition", "attachment;filename=\"" + encodeName(fileName+"."+extName,request) + "\"");
