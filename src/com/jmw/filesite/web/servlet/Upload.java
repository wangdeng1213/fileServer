...
public class Upload extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
	  try{
	    ...
	    String savePath = Constant.CertFilePath;
	    ...
	    String uniquedName=UUID.randomUUID().toString()+"."+extName;
	    FileUtils.writeByteFile(bytes, new File(savePath + "/" + uniquedName));
	    ...
	    String fileInfo="";
	    	 ...
	    	 int h= 0;
	    	  ...
	    	  is.close(); //关闭Stream
	    	 fileInfo = "{fileName:'" + realName + "',fileType:'" + extName + "',fileSize:'" + fileSize + "',savePath:'" + new AesCBC().Encrypt(savePath + uniquedName) + "','width':'"+w+"','height':'"+h+"'}";
