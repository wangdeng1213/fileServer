...
public class UploadAndRenameFive extends HttpServlet
{
...
//        }
        ...
        byte[] zipByte = getEncryptZipByte(new ByteArrayInputStream(bytes),realName.replace(" ","")+"."+extName, "98jk34kxu52#$5422b7cb-d6490a1c57f43bwn56");
  ...
  public synchronized byte[] getEncryptZipByte(InputStream srcStream,String fileName,String password) {
