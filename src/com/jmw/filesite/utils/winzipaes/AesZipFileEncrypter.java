...
import com.jmw.filesite.utils.winzipaes.impl.AESEncrypter;
import com.jmw.filesite.utils.winzipaes.impl.ExtZipEntry;
import com.jmw.filesite.utils.winzipaes.impl.ExtZipOutputStream;
import com.jmw.filesite.utils.winzipaes.impl.ZipFileEntryInputStream;
...
public class AesZipFileEncrypter {
	 ...
	 * Zip + encrypt one "inFile" to one "outZipFile" using "password".
	 */
	public static void zipAndEncrypt(InputStream inFile, OutputStream outFile, String fileName, String password, AESEncrypter encrypter) throws IOException {
		AesZipFileEncrypter enc = new AesZipFileEncrypter(outFile,encrypter);
		try {
			enc.add(fileName,inFile, password);
		} finally {
			enc.close();
		}
	}
